      ...
      <AlertDialog open={confirmOpen} onOpenChange={handleOpenChange}>
        <AlertDialogContent className="border-border">
          ...
          <AlertDialogFooter className="gap-2">
            <AlertDialogCancel 
              disabled={isDeleting}
              className="h-10 border-border hover:bg-muted focus:outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0"
            >
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
              ...
              disabled={isDeleting}
              className="h-10 bg-red-600 text-white hover:bg-red-700 border-none transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0"
            >
              {isDeleting
                ? "Processing..."
